...
//  image_sub = it.subscribe("/perceptual_nodes/harvest_line_stream",100,&QNode::myCallback_img,this);//相机尝试
        ...
        reverse_motor_pub = n.advertise<std_msgs::Int16>("/reverse_motor", 1);
...
//        std::cout<<"left_qtg"<<std::endl;
    ...
    void QNode::pub_reverse_motor(int msg) {
        std_msgs::Int16 reverse_motor;
        reverse_motor.data = msg;
        reverse_motor_pub.publish(reverse_motor);
//        std::cout<<"left_qtg"<<std::endl;
