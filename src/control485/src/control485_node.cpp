...
int main (int argc, char **argv)
{
    ...
    pub1_ = n_.advertise<std_msgs::Float32>("motor_1_speed", 1);
    pub_motor1_speed = &pub1_;

    pub2_ = n_.advertise<std_msgs::Float32>("motor_2_speed", 1);
    pub_motor2_speed = &pub2_;

    pub3_ = n_.advertise<std_msgs::Float32>("motor_3_speed", 1);
    pub_motor3_speed = &pub3_;

//    pub4_ = n_.advertise<std_msgs::Float32>("FH_speed", 1);
//    pub_motor3_speed = &pub4_;
